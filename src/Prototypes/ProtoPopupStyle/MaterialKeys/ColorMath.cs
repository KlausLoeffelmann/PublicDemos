...
/// <summary>
///  Color utilities used by <see cref="MaterialKeyButtonRenderer"/> to derive material shading
///  colors from arbitrary effective colors.
/// </summary>
/// <remarks>
///  <para>
///   Nothing in here assumes a light or dark base color; every derivation is relative to the
///   input, which is what makes the material effect work with saturated, neutral, light, dark
///   and (dark-mode remapped) system colors alike.
///  </para>
/// </remarks>
internal static class ColorMath
{
    ...
    /// <summary>
    ///  Blends the color towards the pole (black or white) that increases contrast against
    ///  itself — lightens dark colors, darkens light colors.
    /// </summary>
    /// <remarks>
    ///  <para>
    ...
    /// <summary>
    ///  Desaturates the color towards a gray of the same luminance and slightly pulls it towards
    ///  a mid tone. Used for disabled surfaces.
    /// </summary>
    ...
    /// <summary>
    ///  Ensures a minimum luminance difference between <paramref name="color"/> and
    ///  <paramref name="against"/> by pushing <paramref name="color"/> away if needed.
    /// </summary>
