...
/// <summary>
///  The installed-extension detail grid for one Visual Studio SKU.
/// </summary>
public sealed partial class VsExtensionsControl : UserControl
{
    public VsExtensionsControl()
    {
        InitializeComponent();
    }

    /// <summary>Replaces the displayed extension list.</summary>
    public void SetItems(IEnumerable<VsExtension> extensions)
    {
        ArgumentNullException.ThrowIfNull(extensions);

        _grid.Rows.Clear();
        foreach (VsExtension extension in extensions)
        {
            _grid.Rows.Add(extension.Name, extension.Publisher, extension.Version, extension.InstallPath);
        }
    }
