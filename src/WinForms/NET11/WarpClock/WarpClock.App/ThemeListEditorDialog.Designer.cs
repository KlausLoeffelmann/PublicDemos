...
partial class ThemeListEditorDialog
{
    ...
    private void InitializeComponent()
    {
        ...
        _introLabel.Size = new Size(1070, 32);
        ...
        _settingsPanel.Controls.Add(_useAsDefaultPathCheckBox, 0, 2);
        _settingsPanel.Controls.Add(_autoRotateCheckBox, 0, 3);
        ...
        _settingsPanel.Location = new Point(15, 53);
        _settingsPanel.Margin = new Padding(3);
        ...
        _settingsPanel.RowStyles.Add(new RowStyle(SizeType.AutoSize));
        _settingsPanel.RowStyles.Add(new RowStyle(SizeType.AutoSize));
        _settingsPanel.Size = new Size(1070, 221);
        ...
        _nameLabel.Size = new Size(75, 32);
        ...
        _nameTextBox.Location = new Point(125, 3);
        _nameTextBox.Name = "_nameTextBox";
        _nameTextBox.Size = new Size(942, 39);
        ...
        _currentPathLabel.Location = new Point(3, 55);
        _currentPathLabel.Name = "_currentPathLabel";
        _currentPathLabel.Size = new Size(116, 32);
        ...
        _currentPathValueLabel.Location = new Point(125, 55);
        _currentPathValueLabel.Name = "_currentPathValueLabel";
        _currentPathValueLabel.Size = new Size(942, 32);
        ...
        _settingsPanel.SetColumnSpan(_useAsDefaultPathCheckBox, 7);
        _useAsDefaultPathCheckBox.Location = new Point(3, 93);
        _useAsDefaultPathCheckBox.Name = "_useAsDefaultPathCheckBox";
        _useAsDefaultPathCheckBox.Size = new Size(384, 36);
        ...
        _settingsPanel.SetColumnSpan(_autoRotateCheckBox, 7);
        _autoRotateCheckBox.Location = new Point(3, 135);
        _autoRotateCheckBox.Name = "_autoRotateCheckBox";
        _autoRotateCheckBox.Size = new Size(305, 36);
        ...
        _dayStartLabel.Location = new Point(3, 186);
        _dayStartLabel.Name = "_dayStartLabel";
        _dayStartLabel.Size = new Size(120, 32);
        _dayStartLabel.TabIndex = 6;
        _dayStartLabel.Text = "Day starts:";
        // 
        // _dayStartPicker
        // 
        _dayStartPicker.Anchor = AnchorStyles.Left;
        _dayStartPicker.Location = new Point(129, 182);
        _dayStartPicker.Name = "_dayStartPicker";
        _dayStartPicker.Size = new Size(120, 39);
        ...
        _nightStartLabel.Location = new Point(255, 186);
        _nightStartLabel.Name = "_nightStartLabel";
        _nightStartLabel.Size = new Size(133, 32);
        _nightStartLabel.TabIndex = 8;
        _nightStartLabel.Text = "Night starts:";
        // 
        // _nightStartPicker
        // 
        _nightStartPicker.Anchor = AnchorStyles.Left;
        _nightStartPicker.Location = new Point(394, 182);
        _nightStartPicker.Name = "_nightStartPicker";
        _nightStartPicker.Size = new Size(120, 39);
        ...
        _rotationMinutesUpDown.Size = new Size(120, 39);
        ...
        _rotationSuffixLabel.Location = new Point(846, 186);
        _rotationSuffixLabel.Name = "_rotationSuffixLabel";
        _rotationSuffixLabel.Size = new Size(87, 32);
        ...
        _validationLabel.Location = new Point(3, 224);
        ...
        _themeGrid.Location = new Point(15, 280);
        ...
        _themeGrid.Size = new Size(1070, 421);
        ...
        _buttonPanel.Location = new Point(591, 707);
        _buttonPanel.Name = "_buttonPanel";
        _buttonPanel.Size = new Size(494, 48);
        ...
        _resetDefaultsButton.Size = new Size(171, 42);
        ...
        _okButton.Location = new Point(180, 3);
        _okButton.Name = "_okButton";
        _okButton.Size = new Size(141, 42);
        ...
        _cancelButton.Location = new Point(327, 3);
        _cancelButton.Name = "_cancelButton";
        _cancelButton.Size = new Size(164, 42);
