...
/// <summary>Letter names. International: B, not H.</summary>
public enum NoteName
{
    ...
    /// <summary>A. A4 is 440 Hz.</summary>
    A,

    /// <summary>B. What German scores call H.</summary>
    B
}

/// <summary>Raises or lowers a note by a semitone.</summary>
public enum Accidental
{
    /// <summary>As written.</summary>
    Natural,

    /// <summary>A semitone up (#).</summary>
    Sharp,

    /// <summary>A semitone down (b).</summary>
    Flat
}

/// <summary>Note durations relative to a whole note (Notenwerte).</summary>
public enum NoteValue
{
    /// <summary>Four beats in 4/4.</summary>
    Whole = 1,

    /// <summary>Two beats.</summary>
    Half = 2,
    ...
    /// <summary>A quarter beat.</summary>
    Sixteenth = 16,

    /// <summary>An eighth of a beat.</summary>
    ThirtySecond = 32
}

/// <summary>How the note is attacked and how much of its duration it actually sounds (Anschlag).</summary>
public enum Articulation
{
    /// <summary>Sounds for ~85 % of its value.</summary>
    Normal,

    /// <summary>Sounds for its full value, running into the next note.</summary>
    Legato,

    /// <summary>Short: ~40 % of its value.</summary>
    Staccato,

    /// <summary>Louder and slightly detached.</summary>
    Accent
}

/// <summary>Decorations played on top of the written note.</summary>
public enum Ornament
{
    /// <summary>The note as written.</summary>
    None,

    /// <summary>Rapid alternation with the note a whole step above (Triller).</summary>
    Trill,

    /// <summary>A single quick alternation with the note above, then the main note (Mordent).</summary>
    Mordent
}
...
public sealed partial record Note
{
    ...
    /// <summary>Letter name.</summary>
    public NoteName Name { get; init; } = NoteName.C;

    /// <summary>Sharp, flat, or natural.</summary>
    public Accidental Accidental { get; init; } = Accidental.Natural;

    /// <summary>Scientific pitch octave. Middle C is C4; A4 is 440 Hz.</summary>
    public int Octave { get; init; } = 4;

    /// <summary>Duration relative to a whole note.</summary>
    public NoteValue Value { get; init; } = NoteValue.Quarter;

    /// <summary>A dot adds half the value.</summary>
    public bool IsDotted { get; init; }

    /// <summary>Three in the time of two (Triole).</summary>
    public bool IsTriplet { get; init; }

    /// <summary>Attack and length within the value.</summary>
    public Articulation Articulation { get; init; } = Articulation.Normal;

    /// <summary>Trill, mordent, or nothing.</summary>
    public Ornament Ornament { get; init; } = Ornament.None;

    /// <summary>A rest: takes time, makes no sound.</summary>
    public bool IsRest { get; init; }

    /// <summary><see langword="true"/> for a sharp.</summary>
    public bool IsSharp
        => Accidental is Accidental.Sharp;

    /// <summary><see langword="true"/> for a flat.</summary>
    public bool IsFlat
        => Accidental is Accidental.Flat;

    /// <summary>MIDI note number (C4 = 60, A4 = 69).</summary>
    ...
    /// <summary>Pitch in Hz.</summary>
    public double Frequency
        => IsRest ? 0 : FrequencyOf(MidiNumber);

    /// <summary>The value including dot and triplet, as a fraction of a whole note.</summary>
    ...
    /// <summary>A rest of a given value.</summary>
    public static Note Rest(NoteValue value = NoteValue.Quarter)
        => new() { IsRest = true, Value = value };

    /// <summary>Frequency for a MIDI note number, A4 = 440.</summary>
    public static double FrequencyOf(int midiNumber)
        => 440.0 * Math.Pow(2, (midiNumber - 69) / 12.0);

    /// <summary>Frequency <paramref name="semitones"/> above (or below) this note.</summary>
