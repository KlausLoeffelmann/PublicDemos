...
partial class OptionsDialog
{
    ...
    private void InitializeComponent()
    {
        ...
        _layout.Controls.Add(_fontSizeLabel, 0, 2);
        _layout.Controls.Add(_fontSize, 1, 2);
        _layout.Controls.Add(_folderLabel, 0, 3);
        _layout.Controls.Add(_folder, 1, 3);
        _layout.Controls.Add(_browse, 2, 3);
        _layout.Controls.Add(_restartNote, 1, 4);
        _layout.Controls.Add(_error, 1, 5);
        _layout.Controls.Add(_buttons, 1, 6);
        ...
        _icons.Name = "_icons";
        _icons.TabIndex = 3;
        _fontSizeLabel.Anchor = AnchorStyles.Left;
        _fontSizeLabel.AutoSize = true;
        _fontSizeLabel.Name = "_fontSizeLabel";
        _fontSizeLabel.TabIndex = 4;
        _fontSizeLabel.Text = "&Font size:";
        _fontSize.AccessibleName = "Application font size";
        _fontSize.Anchor = AnchorStyles.Left | AnchorStyles.Right;
        _fontSize.DropDownStyle = ComboBoxStyle.DropDownList;
        _fontSize.Items.AddRange(new object[] { "Small (WinForms standard)", "Normal (+2 pt)", "Large (+4 pt)", "XXL (+6 pt)" });
        _fontSize.Name = "_fontSize";
        _fontSize.TabIndex = 5;
        ...
        _restartNote.TabIndex = 9;
        _restartNote.Text = "Theme and font-size changes require a restart. System follows Windows at launch. Icon size and folder changes apply immediately.";
