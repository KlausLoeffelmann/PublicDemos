---
name: winforms-audio
description: Develop, diagnose, document, and test the vanilla WinForms.Audio synthesis and WinMM playback library. Use this for tones, notes, samples, mixing, reverb, waveOut failures, or board sound effects.
---

# WinForms Audio Library

## Architecture

`WinForms.Audio` uses the .NET 11 WindowsDesktop/WinForms framework and no external
...
- Refer to the model notes under `WinForms.Audio\Percussion` for factory-target
